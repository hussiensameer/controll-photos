...
Begin VB.Form frmTest 
   ...
   Begin VB.Menu mnuFile 
      ...
      Begin VB.Menu mnuLoad 
         ...
         Shortcut        =   ^O
      End
      Begin VB.Menu mnuOpenMSF 
         Caption         =   "Open with MS Filter"
      End
      Begin VB.Menu mnuSave 
         Caption         =   "&Save"
         Shortcut        =   ^S
      End
      Begin VB.Menu mnuSaveMSF 
         Caption         =   "Save with MS Filter"
      End
...
Private Sub Form_Load()
   ...
   Caption = "Ark's image processing demo"
   lblProgress = ""
...
Private Sub mnuFile_Click()
   mnuSave.Enabled = (PicEx.Picture <> 0)
   mnuOpenMSF.Enabled = PicEx.MSF_ImportSupported
   mnuSaveMSF.Enabled = PicEx.MSF_ExportSupported And (PicEx.Picture <> 0)
End Sub
...
Private Sub picContainer_Resize()
   ...
   ProgressBar1.Move lblProgress.Width, lblProgress.Top, ScaleWidth - lblProgress.Width
End Sub
